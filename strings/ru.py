...
in_cart_format_string = "{quantity}кг в корзине"
...
csv_caption = "Файл 📄 .csv сгенерирован, и содержит все транзакции из базы данных бота.\n" \
              "Вы можете открыть этот файл с помощью LibreOffice Calc, чтобы просмотреть детали."

# Conversation: the start command was sent and the bot should welcome the user
conversation_after_start = "Привет!\n" \
                           "Добро пожаловать в BFood!\n"
...
conversation_switch_to_user_mode = " Вы перешли в режим 👤 Покупателя.\n" \
                                   "Если хотите вернуться в режим 💼 Менеджера, перезапустите с помощью команды /start."
...
# Order product: notes?
ask_order_notes = "🏠Оставьте свой адрес для доставки\n" \
                  "(<b>Город, улица, номер дома, номер квартиры</b>)\n" \
                  "\n" \
                  "<i>Также можете указать дополнительную информацию к заказу ниже</i>\n" \
